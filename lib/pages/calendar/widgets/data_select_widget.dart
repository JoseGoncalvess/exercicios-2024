...
class _DataSelectWidgetState extends State<DataSelectWidget> {
   ...
   Widget build(BuildContext context) {
       return SizedBox(
            ...
            child: Text( "Nov\n2023", textAlign: TextAlign.center, style: TextStyle(fontSize: MediaQuery.sizeOf(context).width *0.05, fontWeight: FontWeight.w700, ),),
              ),
              Container(
              ...
              Row(
                children: data.map((day) => GestureDetector(
                  onTap: () => {
                  setState(() {
                    pageValue = day;
                  }),
                  ...
                  child: CardDateSelectWidget(day: day.toString(),select: pageValue == day,)) ).toList(),
              ),
              )
              ]),
            );
